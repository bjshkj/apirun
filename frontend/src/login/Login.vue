...
<script>
import {publicKeyEncrypt, saveLocalStorage, getQueryVariable} from '@/common/js/utils';
...
const license = requireComponent.keys().length > 0 ? requireComponent("./license/LicenseMessage.vue") : {};
