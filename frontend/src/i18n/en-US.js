export default {
  ...
  organization: {
    ...
    integration: {
      ...
      input_jira_url: 'Please enter Jira address, for example: https://apirun.atlassian.net/',
  ...
  api_test: {
    ...
    api_import: {
      ...
      ms_env_import_file_limit: "It supports JSON format files exported through apirun",
