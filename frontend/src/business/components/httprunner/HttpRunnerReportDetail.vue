    ...
    <ms-main-container>
      <el-card>
        ...
        <el-descriptions border :column="4" v-loading="isSummaryLoading">
          <el-descriptions-item label="时间" span="2">{{report.stime | timestampFormatDate}}  ~  {{report.ftime | timestampFormatDate}}</el-descriptions-item>
                ...
                <div class="inner-table">
                  <el-table :data="row.testStepResults" >
                    ...
                    <el-table-column
                      ...
                      prop="method">
                      <template slot-scope="{row}">
                        <el-tag size="mini" :style="{'background-color': getColor(true, row.method), border: getColor(true, row.method)}" class="api-el-tag">
                          {{ row.method}}
                        </el-tag>
                      </template>
                    </el-table-column>
                    ...
                    <el-table-column
                      ...
                      <template slot-scope="childScope">
                        ...
                        <el-button type="text" size="small" @click="openErrorDialog(childScope.row)" v-if="childScope.row.attachment">报错信息</el-button>
                      </template>
                    </el-table-column>
                  </el-table>
                </div>
      ...
      <el-dialog
        ...
        <div class="dialog-content">
          ...
          <table v-if="curItem.requestInfo">
            ...
            <tr>
              ...
              <td>
                <el-tag
                  size="mini"
                  :style="{'background-color': getColor(true, curItem.requestInfo.method), border: getColor(true, curItem.requestInfo.method)}" class="api-el-tag">
            ...
            <tr>
              <th>headers</th>
              <td><pre v-html="curItem.requestInfo.headers"></pre></td>
            </tr>
            <tr>
              <th>body</th>
              <td><pre v-html="curItem.requestInfo.body"></pre></td>
            </tr>
          </table>
          ...
          <table v-if="curItem.responseInfo">
            ...
            <tr>
              <th>headers</th>
              <td><pre v-html="curItem.responseInfo.headers"></pre></td>
            </tr>
            <tr>
              <th>cookies</th>
              <td><pre v-html="curItem.responseInfo.cookies"></pre></td>
            </tr>
            <tr>
              <th>encoding</th>
            ...
            <tr>
              <th>body</th>
              <td><pre v-html="curItem.responseInfo.body"></pre></td>
            </tr>
          </table>
      ...
      <el-dialog
        ...
        <div class="dialog-content">
          ...
          <div><pre v-html="curItem.attachment"></pre></div>
        </div>
