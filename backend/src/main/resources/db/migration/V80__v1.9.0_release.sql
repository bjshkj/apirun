...
VALUES ('5d7c87d2-f405-4ec1-9a3d-71b514cdfda3','default','apirun','','',1,1,'global','',unix_timestamp() * 1000,unix_timestamp() * 1000);
...
VALUES ('apirun.module.api', 'ENABLE', 'text', 1);
INSERT INTO system_parameter (param_key, param_value, type, sort)
VALUES ('apirun.module.performance', 'ENABLE', 'text', 1);
INSERT INTO system_parameter (param_key, param_value, type, sort)
VALUES ('apirun.module.reportStat', 'ENABLE', 'text', 1);
INSERT INTO system_parameter (param_key, param_value, type, sort)
VALUES ('apirun.module.testTrack', 'ENABLE', 'text', 1);
