...
import io.apirun.api.parse.old.ApiImportParser;
import io.apirun.api.parse.old.ApiImportParserFactory;
import io.apirun.api.parse.old.JmeterDocumentParser;
import io.apirun.base.domain.*;
import io.apirun.base.mapper.ApiTestFileMapper;
import io.apirun.base.mapper.ApiTestMapper;
import io.apirun.base.mapper.ext.ExtApiTestMapper;
...
import io.apirun.commons.constants.ScheduleType;
...
import io.apirun.job.sechedule.ApiTestJob;
import io.apirun.service.FileService;
import io.apirun.service.QuotaService;
...
public class APITestService {
    ...
    public JmxInfoDTO updateJmxString(String jmxString, String testNameParam, boolean isFromScenario) {
        ...
        try {
            ...
            Document doc = EngineSourceParserFactory.getDocument(new ByteArrayInputStream(jmxString.getBytes("utf-8")));// 获取可续保保单列表报文模板
            ...
            for (Element hashTreeItemElement : scriptElementItemList) {
                ...
                if (org.apache.commons.lang3.StringUtils.equals(className, "JSR223PostProcessor")) {
                    ...
                    for (Element scriptElement : scriptElements) {
                        ...
                        if ("script".equals(scriptName) && contentValue.startsWith("io.apirun.api.jmeter.JMeterVars.addVars")) {
                            isRemove = true;
                            removeElement.add(hashTreeItemElement);
                        }
                    }
