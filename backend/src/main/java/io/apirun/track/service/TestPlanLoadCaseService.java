...
import io.apirun.track.request.testplan.LoadCaseReportBatchRequest;
import io.apirun.track.request.testplan.LoadCaseReportRequest;
import io.apirun.track.request.testplan.LoadCaseRequest;
import io.apirun.track.request.testplan.RunBatchTestPlanRequest;
import io.apirun.track.service.utils.ParallelExecTask;
import io.apirun.track.service.utils.SerialExecTask;
        ...
        if (request.getConfig() != null && request.getConfig().getMode().equals(RunModeConstants.SERIAL.toString())) {
            try {
                ...
                if (StringUtils.isNotEmpty(message)){
                    message = message.replace("io.apirun.commons.exception.MSException:","");
