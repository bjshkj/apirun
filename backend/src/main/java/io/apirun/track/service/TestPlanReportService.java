...
import io.apirun.base.mapper.ext.ExtTestPlanApiCaseMapper;
import io.apirun.base.mapper.ext.ExtTestPlanMapper;
import io.apirun.base.mapper.ext.ExtTestPlanReportMapper;
...
import io.apirun.track.Factory.ReportComponentFactory;
import io.apirun.track.domain.ReportComponent;
...
import io.apirun.track.request.testplan.LoadCaseRequest;
...
public class TestPlanReportService {
    ...
    private final ExecutorService executorService = Executors.newFixedThreadPool(cpuCount/2);
        ...
        executorService.submit(() -> {
            ...
            while (performaneReportIDList.size() > 0) {
                ...
                if (performaneReportIDList.isEmpty()) {
                    ...
                    try {
                        //查询定时任务是否关闭
                        Thread.sleep(200);// 检查 loadtest 的状态
