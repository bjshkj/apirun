...
public class ShiroUtils {
    ...
    public static void loadBaseFilterChain(Map<String, String> filterChainDefinitionMap){
        ...
        filterChainDefinitionMap.put("/newlogin", "anon");
        ...
        filterChainDefinitionMap.put("/api/httprunner/**", "user");
        filterChainDefinitionMap.put("/httpruner/**", "user");
        filterChainDefinitionMap.put("/httpRunnerTask/**", "user");
        filterChainDefinitionMap.put("/gitLab/**", "user");
        //对外提供查看场景报告接口
        filterChainDefinitionMap.put("/httpRunner/**", "anon");
        filterChainDefinitionMap.put("/jmeter/**", "anon");
        filterChainDefinitionMap.put("/api/scenario/report/get/**", "user");
        filterChainDefinitionMap.put("/tracegeelib/**", "anon");
    ...
    public static void ignoreCsrfFilter(Map<String, String> filterChainDefinitionMap) {
        ...
        filterChainDefinitionMap.put("/api/httprunner/result/detail", "apikey, authc"); // 跳转到 /api/httprunner/result/detail 不用校验 csrf
